...
export default async function ReferentDashboardPage({
  ...
  console.log("ID de l'étape active (côté serveur) :", searchParams.etapeId);

  // (Plus tard, tu utiliseras searchParams.etapeId pour fetch les données Prisma)
  ...
  return (
    <div className="h-full max-h-screen flex flex-col overflow-hidden">
      ...
      <p className="mt-4">
        Contenu du dashboard pour l'étape (ID: {searchParams.etapeId || "Non sélectionnée"})
      </p>
