  ...
  return (
    <div className="space-y-6 pt-2">
      ...
      <div className="space-y-3">
        ...
        <div className="bg-default-50 rounded-xl p-4 md:p-6 border border-default-100">
           <p className="text-sm md:text-base text-default-800 leading-relaxed whitespace-pre-wrap">
